<?php
    if(isset($_POST['submit']))
    {
        ...
        $chemi_request = $_POST['reqchemi'];
        $quant_chemi = $_POST['quantchemical'];
        $chemi_vol = $_POST['chemivolume'];
        ...
        $subject = "Request from: ".$name." for ".$chemi_request." of quantity ".$quant_chemi." in  ".$chemi_vol." for  ".$purpose." .";
            ...
            <body>
                <table style='width:800px;'>
                    <tbody>
                        ...
                        <tr>
                            <td style='width:190px;'><p>Required Chemical :</p></td>
                            <td style='width:400px'><p>$chemi_request</p></td>
                        </tr>
                        <tr>
                            <td style='width:190px;'><p>Volume for requested Chemical :</p></td>
                            <td style='width:400px'><p>$chemi_vol</p></td>
                        </tr>
                        <tr>
                            <td style='width:190px;'><p>Purpose :</p></td>
                            <td style='width:400px'><p>$purpose</p></td>
                        </tr>
                        <tr>
